...
def run_model_v3(
    ...
    model_path = models_dir / "battery_model_v3_gru.keras"
    metrics_path = models_dir / "battery_model_v3_metrics.json"

    model.save(model_path)

    metrics = {
        "model_version": "v3",
        "model_name": "TwoLayerGRU",
        "mae": mae,
        "r2": r2,
        "target_mean": y_mean,
        "target_std": y_std,
    ...
    print(f"Model v3 complete: MAE={mae:.6f}, R2={r2:.6f}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Battery model v3 - two-layer GRU")
